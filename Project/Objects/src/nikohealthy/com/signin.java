...
public class signin extends Activity implements B4AActivity{
	public static signin mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "nikohealthy.com", "nikohealthy.com.signin");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (signin).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "nikohealthy.com", "nikohealthy.com.signin");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "nikohealthy.com.signin", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (signin) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (signin) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (signin) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public anywheresoftware.b4a.objects.EditTextWrapper _txtoccupation = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 67;BA.debugLine="Activity.LoadLayout(\"signin\")";
mostCurrent._activity.LoadLayout("signin",mostCurrent.activityBA);
 //BA.debugLineNum = 68;BA.debugLine="ScrollView1.Panel.LoadLayout(\"register\")";
mostCurrent._scrollview1.getPanel().LoadLayout("register",mostCurrent.activityBA);
 //BA.debugLineNum = 69;BA.debugLine="RadioButton1.Checked=True";
mostCurrent._radiobutton1.setChecked(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 70;BA.debugLine="RadioButton4.Checked=True";
...
public static String  _btnback_click() throws Exception{
 //BA.debugLineNum = 81;BA.debugLine="Sub btnBack_Click";
...
String _query = "";
 //BA.debugLineNum = 89;BA.debugLine="Sub btnsignup_Click";
 //BA.debugLineNum = 90;BA.debugLine="ProgressDialogShow(\"Please wait...\") 'oouuu young";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Please wait...");
 //BA.debugLineNum = 91;BA.debugLine="fname=txtfname.Text";
mostCurrent._vvvvvvvvv0 = mostCurrent._txtfname.getText();
 //BA.debugLineNum = 92;BA.debugLine="lname=txtlname.Text";
mostCurrent._vvvvvvvvvv1 = mostCurrent._txtlname.getText();
 //BA.debugLineNum = 93;BA.debugLine="mname=txtmname.Text";
mostCurrent._vvvvvvvvvv2 = mostCurrent._txtmname.getText();
 //BA.debugLineNum = 94;BA.debugLine="age=txtage.Text";
mostCurrent._vvvvvvvvvv3 = mostCurrent._txtage.getText();
 //BA.debugLineNum = 95;BA.debugLine="phone=txtphone.Text";
mostCurrent._vvvvvvvvvv4 = mostCurrent._txtphone.getText();
 //BA.debugLineNum = 96;BA.debugLine="email=txtemail.Text";
mostCurrent._vvvvvvvvvv5 = mostCurrent._txtemail.getText();
 //BA.debugLineNum = 97;BA.debugLine="username=txtusername.Text";
mostCurrent._vvvvv3 = mostCurrent._txtusername.getText();
 //BA.debugLineNum = 98;BA.debugLine="password=txtpassword.Text";
mostCurrent._vvvvv4 = mostCurrent._txtpassword.getText();
 //BA.debugLineNum = 99;BA.debugLine="Residence=txtresidence.Text";
mostCurrent._vvvvvvvvvv6 = mostCurrent._txtresidence.getText();
 //BA.debugLineNum = 100;BA.debugLine="height=txtheight.Text";
mostCurrent._vvvvvvvvvv7 = mostCurrent._txtheight.getText();
 //BA.debugLineNum = 101;BA.debugLine="weight=txtweight.Text";
mostCurrent._vvvvvvvv3 = mostCurrent._txtweight.getText();
 //BA.debugLineNum = 102;BA.debugLine="occupation=txtoccupation.Text";
mostCurrent._vvvvvvvvvv0 = mostCurrent._txtoccupation.getText();
 //BA.debugLineNum = 103;BA.debugLine="medhistory=txtmedic.Text";
mostCurrent._vvvvvvvvvvv1 = mostCurrent._txtmedic.getText();
 //BA.debugLineNum = 104;BA.debugLine="confirmpassword=txtconfirmpass.Text";
mostCurrent._vvvvvvvvvvv2 = mostCurrent._txtconfirmpass.getText();
 //BA.debugLineNum = 106;BA.debugLine="If fname.Trim.Length==0 Then";
if (mostCurrent._vvvvvvvvv0.trim().length()==0) { 
 //BA.debugLineNum = 107;BA.debugLine="ToastMessageShow(\"Please enter your First Name\",T";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Please enter your First Name",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 109;BA.debugLine="ToastMessageShow(\"Please enter your Middle Name\",";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Please enter your Middle Name",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 111;BA.debugLine="ToastMessageShow(\"Please enter your Last Name\",Tr";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Please enter your Last Name",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 113;BA.debugLine="ToastMessageShow(\"Please enter your Age\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Please enter your Age",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 115;BA.debugLine="ToastMessageShow(\"Please enter your Phone Number\"";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Please enter your Phone Number",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 117;BA.debugLine="ToastMessageShow(\"Please enter your Email\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Please enter your Email",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 119;BA.debugLine="ToastMessageShow(\"Please enter your Username\",Tru";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Please enter your Username",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 121;BA.debugLine="ToastMessageShow(\"Password should be more than 6";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Password should be more than 6 characters",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 123;BA.debugLine="ToastMessageShow(\"Passwords does not match! Try A";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Passwords does not match! Try Again",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 125;BA.debugLine="ToastMessageShow(\"Please enter your Residence\",Tr";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Please enter your Residence",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 127;BA.debugLine="ToastMessageShow(\"Please enter your Weight\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Please enter your Weight",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 129;BA.debugLine="ToastMessageShow(\"Please enter your Height\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Please enter your Height",anywheresoftware.b4a.keywords.Common.True);
 }else if(mostCurrent._vvvvvvvvvv0.trim().length()==0) { 
 //BA.debugLineNum = 131;BA.debugLine="ToastMessageShow(\"Please enter your Occupation\",T";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Please enter your Occupation",anywheresoftware.b4a.keywords.Common.True);
 }else if(mostCurrent._vvvvvvvvvvv1.trim().length()==0) { 
 //BA.debugLineNum = 133;BA.debugLine="ToastMessageShow(\"Please enter your Health Condit";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Please enter your Health Condition Status",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 135;BA.debugLine="radiomaritalstatus";
_vvvvvvvvvvv3();
 //BA.debugLineNum = 136;BA.debugLine="genderfill";
_vvvvvvvvvvv4();
 //BA.debugLineNum = 137;BA.debugLine="Dim query=\"INSERT INTO `user` (`User_id`, `FirstN";
_query = "INSERT INTO `user` (`User_id`, `FirstName`, `MiddleName`, `LastName`, `Age`, `maritalstatus`, `Phone`, `Email`, `Username`, `Password`, `Gender`, `Residence`, `weight`, `height`, `occupation`, `medicalhistory`, `status`, `Image`, `Updated_at`) VALUES (NULL, '"+mostCurrent._vvvvvvvvv0+"', '"+mostCurrent._vvvvvvvvvv2+"', '"+mostCurrent._vvvvvvvvvv1+"', '"+mostCurrent._vvvvvvvvvv3+"', '"+mostCurrent._vvvvvvvvvvv5+"', '"+mostCurrent._vvvvvvvvvv4+"', '"+mostCurrent._vvvvvvvvvv5+"', '"+mostCurrent._vvvvv3+"', '"+mostCurrent._vvvvv4+"', '"+mostCurrent._vvvvvvvvvvv6+"', '"+mostCurrent._vvvvvvvvvv6+"', '"+mostCurrent._vvvvvvvv3+"', '"+mostCurrent._vvvvvvvvvv7+"', '"+mostCurrent._vvvvvvvvvv0+"', '"+mostCurrent._vvvvvvvvvvv1+"', 'online', 'na', '"+mostCurrent._vvvvvv4._v7(mostCurrent.activityBA)+"')";
 //BA.debugLineNum = 138;BA.debugLine="ExecuteRemoteQuery(query, signup)";
_vvvvvvv4(_query,_vvvvvvvvvvv7);
 //BA.debugLineNum = 139;BA.debugLine="ToastMessageShow(\"Successfully added \"&username&\"";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Successfully added "+mostCurrent._vvvvv3+" as User,Now log in as user",anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 142;BA.debugLine="End Sub";
return "";
}
public static String  _btnupload_click() throws Exception{
 //BA.debugLineNum = 85;BA.debugLine="Sub btnupload_Click";
 //BA.debugLineNum = 86;BA.debugLine="ImageView2.Bitmap=LoadBitmap(File.DirAssets,\"defau";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"defaultimage.png").getObject()));
...
_job._initialize(processBA,_jobname,signin.getObject());
 //BA.debugLineNum = 146;BA.debugLine="job.PostString(global.API,Query)";
_job._vvvv7(mostCurrent._vvvvvv4._v6,_query);
 //BA.debugLineNum = 147;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvvvvvv4() throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Sub genderfill";
 //BA.debugLineNum = 179;BA.debugLine="If RadioButton4.Checked Then";
if (mostCurrent._radiobutton4.getChecked()) { 
 //BA.debugLineNum = 180;BA.debugLine="mygender=\"Male\"";
mostCurrent._vvvvvvvvvvv6 = "Male";
 }else if(mostCurrent._radiobutton5.getChecked()) { 
 //BA.debugLineNum = 182;BA.debugLine="mygender=\"Female\"";
...
mostCurrent._txtheight = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Private txtoccupation As EditText";
mostCurrent._txtoccupation = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Private txtmedic As EditText";
mostCurrent._txtmedic = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 35;BA.debugLine="Dim fname As String";
mostCurrent._vvvvvvvvv0 = "";
 //BA.debugLineNum = 36;BA.debugLine="Dim mname As String";
mostCurrent._vvvvvvvvvv2 = "";
 //BA.debugLineNum = 37;BA.debugLine="Dim lname As String";
mostCurrent._vvvvvvvvvv1 = "";
 //BA.debugLineNum = 38;BA.debugLine="Dim age As String";
mostCurrent._vvvvvvvvvv3 = "";
 //BA.debugLineNum = 39;BA.debugLine="Dim maritalstatus As String";
mostCurrent._vvvvvvvvvvv5 = "";
 //BA.debugLineNum = 40;BA.debugLine="Dim phone As String";
mostCurrent._vvvvvvvvvv4 = "";
 //BA.debugLineNum = 41;BA.debugLine="Dim email As String";
mostCurrent._vvvvvvvvvv5 = "";
 //BA.debugLineNum = 42;BA.debugLine="Dim username As String";
mostCurrent._vvvvv3 = "";
 //BA.debugLineNum = 43;BA.debugLine="Dim password As String";
mostCurrent._vvvvv4 = "";
 //BA.debugLineNum = 44;BA.debugLine="Dim Residence As String";
mostCurrent._vvvvvvvvvv6 = "";
 //BA.debugLineNum = 45;BA.debugLine="Dim weight As String";
mostCurrent._vvvvvvvv3 = "";
 //BA.debugLineNum = 46;BA.debugLine="Dim height As String";
mostCurrent._vvvvvvvvvv7 = "";
 //BA.debugLineNum = 47;BA.debugLine="Dim occupation As String";
mostCurrent._vvvvvvvvvv0 = "";
 //BA.debugLineNum = 48;BA.debugLine="Dim medhistory As String";
mostCurrent._vvvvvvvvvvv1 = "";
 //BA.debugLineNum = 49;BA.debugLine="Dim mygender As String";
mostCurrent._vvvvvvvvvvv6 = "";
 //BA.debugLineNum = 50;BA.debugLine="Dim confirmpassword As String";
mostCurrent._vvvvvvvvvvv2 = "";
 //BA.debugLineNum = 55;BA.debugLine="Private RadioButton1 As RadioButton 'single";
mostCurrent._radiobutton1 = new anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper();
 //BA.debugLineNum = 56;BA.debugLine="Private RadioButton2 As RadioButton 'married";
mostCurrent._radiobutton2 = new anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper();
 //BA.debugLineNum = 57;BA.debugLine="Private RadioButton3 As RadioButton 'deceased";
mostCurrent._radiobutton3 = new anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper();
 //BA.debugLineNum = 58;BA.debugLine="Private RadioButton4 As RadioButton";
mostCurrent._radiobutton4 = new anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper();
 //BA.debugLineNum = 59;BA.debugLine="Private RadioButton5 As RadioButton";
mostCurrent._radiobutton5 = new anywheresoftware.b4a.objects.CompoundButtonWrapper.RadioButtonWrapper();
 //BA.debugLineNum = 60;BA.debugLine="Private ImageView2 As ImageView";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 151;BA.debugLine="Dim u As StringUtils";
_u = new anywheresoftware.b4a.objects.StringUtils();
 //BA.debugLineNum = 152;BA.debugLine="Try";
try { //BA.debugLineNum = 153;BA.debugLine="If Job.Success Then";
if (_job._vvvvv2) { 
 //BA.debugLineNum = 154;BA.debugLine="Dim res As String";
_res = "";
 //BA.debugLineNum = 155;BA.debugLine="res = Job.GetString";
_res = _job._vvvv3();
 //BA.debugLineNum = 156;BA.debugLine="Log(\"Response from server: \" & res)";
anywheresoftware.b4a.keywords.Common.Log("Response from server: "+_res);
 //BA.debugLineNum = 157;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 158;BA.debugLine="parser.Initialize(res)";
_parser.Initialize(_res);
 }else {
 //BA.debugLineNum = 161;BA.debugLine="ToastMessageShow(\"Failed, make sure you have an";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Failed, make sure you have an internet connection.",anywheresoftware.b4a.keywords.Common.True);
			...
			processBA.setLastException(e14); //BA.debugLineNum = 164;BA.debugLine="ToastMessageShow(LastException,True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 166;BA.debugLine="Job.Release";
_job._vvvv0();
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Private signup=\"SIGNUP\" As String";
_vvvvvvvvvvv7 = BA.__b (new byte[] {86,82,49,115,90,92}, 206800);
 //BA.debugLineNum = 10;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvvvvvv3() throws Exception{
 //BA.debugLineNum = 168;BA.debugLine="Sub radiomaritalstatus";
 //BA.debugLineNum = 169;BA.debugLine="If RadioButton1.Checked Then";
if (mostCurrent._radiobutton1.getChecked()) { 
 //BA.debugLineNum = 170;BA.debugLine="maritalstatus=\"Single\"";
mostCurrent._vvvvvvvvvvv5 = "Single";
 }else if(mostCurrent._radiobutton2.getChecked()) { 
 //BA.debugLineNum = 172;BA.debugLine="maritalstatus=\"Married\"";
mostCurrent._vvvvvvvvvvv5 = "Married";
 }else if(mostCurrent._radiobutton3.getChecked()) { 
 //BA.debugLineNum = 174;BA.debugLine="maritalstatus=\"Deceased\"";
