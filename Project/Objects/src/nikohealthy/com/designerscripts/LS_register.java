...
//BA.debugLineNum = 19;BA.debugLine="Panel13.HorizontalCenter=50%x"[register/General script]
views.get("panel13").vw.setLeft((int)((50d / 100 * width) - (views.get("panel13").vw.getWidth() / 2)));
//BA.debugLineNum = 20;BA.debugLine="Panel14.HorizontalCenter=50%x"[register/General script]
views.get("panel14").vw.setLeft((int)((50d / 100 * width) - (views.get("panel14").vw.getWidth() / 2)));
//BA.debugLineNum = 21;BA.debugLine="Panel15.HorizontalCenter=50%x"[register/General script]
views.get("panel15").vw.setLeft((int)((50d / 100 * width) - (views.get("panel15").vw.getWidth() / 2)));
//BA.debugLineNum = 22;BA.debugLine="Panel16.HorizontalCenter=50%x"[register/General script]
views.get("panel16").vw.setLeft((int)((50d / 100 * width) - (views.get("panel16").vw.getWidth() / 2)));
//BA.debugLineNum = 23;BA.debugLine="Panel17.HorizontalCenter=50%x"[register/General script]
views.get("panel17").vw.setLeft((int)((50d / 100 * width) - (views.get("panel17").vw.getWidth() / 2)));
//BA.debugLineNum = 25;BA.debugLine="ImageView2.HorizontalCenter=50%x"[register/General script]
views.get("imageview2").vw.setLeft((int)((50d / 100 * width) - (views.get("imageview2").vw.getWidth() / 2)));
//BA.debugLineNum = 27;BA.debugLine="btnupload.HorizontalCenter=50%x"[register/General script]
views.get("btnupload").vw.setLeft((int)((50d / 100 * width) - (views.get("btnupload").vw.getWidth() / 2)));
//BA.debugLineNum = 28;BA.debugLine="btnsignup.HorizontalCenter=50%x"[register/General script]
