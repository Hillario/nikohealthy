...
public class contactsportalusers extends Activity implements B4AActivity{
	public static contactsportalusers mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "nikohealthy.com", "nikohealthy.com.contactsportalusers");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (contactsportalusers).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "nikohealthy.com", "nikohealthy.com.contactsportalusers");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "nikohealthy.com.contactsportalusers", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (contactsportalusers) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (contactsportalusers) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return contactsportalusers.class;
	}
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (contactsportalusers) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 30;BA.debugLine="Activity.LoadLayout(\"contactsusers\")";
mostCurrent._activity.LoadLayout("contactsusers",mostCurrent.activityBA);
 //BA.debugLineNum = 31;BA.debugLine="ProgressDialogShow(\"Loading users, please wait..";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Loading users, please wait...");
 //BA.debugLineNum = 32;BA.debugLine="fillscrollview";
_vvvvvvvvvvvv7();
...
nikohealthy.com.httpjob _job = null;
 //BA.debugLineNum = 51;BA.debugLine="Sub ExecuteRemoteQuery(Query As String, JobName As";
 //BA.debugLineNum = 52;BA.debugLine="Dim job As HttpJob";
_job = new nikohealthy.com.httpjob();
 //BA.debugLineNum = 53;BA.debugLine="job.Initialize(JobName, Me)";
_job._initialize(processBA,_jobname,contactsportalusers.getObject());
 //BA.debugLineNum = 54;BA.debugLine="job.PostString(global.API,Query)";
...
String _query = "";
 //BA.debugLineNum = 43;BA.debugLine="Sub fillscrollview";
 //BA.debugLineNum = 44;BA.debugLine="Dim query=\"SELECT * FROM user\" As String";
_query = "SELECT * FROM user";
 //BA.debugLineNum = 45;BA.debugLine="ExecuteRemoteQuery(query, contactsspec)";
...
mostCurrent._vv7 = mostCurrent._vvvvvv2._vv7;
 //BA.debugLineNum = 20;BA.debugLine="Dim myid=Main.myid As String";
mostCurrent._vv0 = mostCurrent._vvvvvv2._vv0;
 //BA.debugLineNum = 21;BA.debugLine="Dim mytask=Main.mytask As String";
mostCurrent._vvv1 = mostCurrent._vvvvvv2._vvv1;
 //BA.debugLineNum = 22;BA.debugLine="Dim myspec=Main.spec As String";
mostCurrent._vvvvvvvvvvvv0 = mostCurrent._vvvvvv2._vvv2;
 //BA.debugLineNum = 23;BA.debugLine="Dim scvpanel As Panel";
...
anywheresoftware.b4a.objects.ButtonWrapper _mybtn = null;
String _myuser = "";
String _myemail = "";
String _mystatus = "";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 59;BA.debugLine="Dim u As StringUtils";
_u = new anywheresoftware.b4a.objects.StringUtils();
 //BA.debugLineNum = 60;BA.debugLine="Try";
try { //BA.debugLineNum = 61;BA.debugLine="If Job.Success Then";
if (_job._vvvvv2) { 
 //BA.debugLineNum = 62;BA.debugLine="Dim res As String";
_res = "";
 //BA.debugLineNum = 63;BA.debugLine="res = Job.GetString";
_res = _job._vvvv3();
 //BA.debugLineNum = 64;BA.debugLine="Log(\"Response from server: \" & res)";
anywheresoftware.b4a.keywords.Common.Log("Response from server: "+_res);
 //BA.debugLineNum = 65;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 66;BA.debugLine="parser.Initialize(res)";
_parser.Initialize(_res);
 //BA.debugLineNum = 67;BA.debugLine="If Job.JobName==contactsspec Then";
if ((_job._vvvvv1).equals(_vvvvvvvvvvvvv1)) { 
 //BA.debugLineNum = 68;BA.debugLine="Dim PARAMETERS As List";
_parameters = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 69;BA.debugLine="PARAMETERS = parser.NextArray 'returns a list";
_parameters = _parser.NextArray();
 //BA.debugLineNum = 70;BA.debugLine="For Each rootMap As Map In PARAMETERS";
...
_rootmap.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(group13.Get(index13)));
 //BA.debugLineNum = 71;BA.debugLine="Dim myuserid As String=rootMap.Get(\"User_id\")";
_myuserid = BA.ObjectToString(_rootmap.Get((Object)("User_id")));
 //BA.debugLineNum = 72;BA.debugLine="Dim firstname As String=rootMap.Get(\"FirstName";
_firstname = BA.ObjectToString(_rootmap.Get((Object)("FirstName")));
 //BA.debugLineNum = 73;BA.debugLine="Dim middlename As String=rootMap.Get(\"MiddleNa";
_middlename = BA.ObjectToString(_rootmap.Get((Object)("MiddleName")));
 //BA.debugLineNum = 74;BA.debugLine="Dim lastname As String =rootMap.Get(\"LastName\"";
_lastname = BA.ObjectToString(_rootmap.Get((Object)("LastName")));
 //BA.debugLineNum = 75;BA.debugLine="Dim age As String=rootMap.Get(\"Age\")";
_age = BA.ObjectToString(_rootmap.Get((Object)("Age")));
 //BA.debugLineNum = 76;BA.debugLine="Dim maritalstatus As String=rootMap.Get(\"marit";
_maritalstatus = BA.ObjectToString(_rootmap.Get((Object)("maritalstatus")));
 //BA.debugLineNum = 77;BA.debugLine="Dim phone As String=rootMap.Get(\"Phone\")";
_phone = BA.ObjectToString(_rootmap.Get((Object)("Phone")));
 //BA.debugLineNum = 78;BA.debugLine="Dim email As String=rootMap.Get(\"Email\")";
_email = BA.ObjectToString(_rootmap.Get((Object)("Email")));
 //BA.debugLineNum = 79;BA.debugLine="Dim username As String=rootMap.Get(\"Username\")";
_username = BA.ObjectToString(_rootmap.Get((Object)("Username")));
 //BA.debugLineNum = 80;BA.debugLine="Dim password As String=rootMap.Get(\"Password\")";
_password = BA.ObjectToString(_rootmap.Get((Object)("Password")));
 //BA.debugLineNum = 81;BA.debugLine="Dim gender As String=rootMap.Get(\"Gender\")";
_gender = BA.ObjectToString(_rootmap.Get((Object)("Gender")));
 //BA.debugLineNum = 82;BA.debugLine="Dim residence As String=rootMap.Get(\"Residence";
_residence = BA.ObjectToString(_rootmap.Get((Object)("Residence")));
 //BA.debugLineNum = 83;BA.debugLine="Dim weight As String=rootMap.Get(\"weight\")";
_weight = BA.ObjectToString(_rootmap.Get((Object)("weight")));
 //BA.debugLineNum = 84;BA.debugLine="Dim height As String=rootMap.Get(\"height\")";
_height = BA.ObjectToString(_rootmap.Get((Object)("height")));
 //BA.debugLineNum = 85;BA.debugLine="Dim task As String=rootMap.Get(\"occupation\")";
_task = BA.ObjectToString(_rootmap.Get((Object)("occupation")));
 //BA.debugLineNum = 86;BA.debugLine="Dim medicalhistory As String=rootMap.Get(\"medi";
_medicalhistory = BA.ObjectToString(_rootmap.Get((Object)("medicalhistory")));
 //BA.debugLineNum = 87;BA.debugLine="Dim onlinestatus As String=rootMap.Get(\"status";
_onlinestatus = BA.ObjectToString(_rootmap.Get((Object)("status")));
 //BA.debugLineNum = 88;BA.debugLine="Dim image As String=rootMap.Get(\"Image\")";
_image = BA.ObjectToString(_rootmap.Get((Object)("Image")));
 //BA.debugLineNum = 89;BA.debugLine="Dim updatedat As String=rootMap.Get(\"Updated_a";
_updatedat = BA.ObjectToString(_rootmap.Get((Object)("Updated_at")));
 }
;
 //BA.debugLineNum = 93;BA.debugLine="Dim userimage As Bitmap";
_userimage = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 94;BA.debugLine="Dim PanelTop,PanelHeight,lblthreadsTop As Int";
_paneltop = 0;
_panelheight = 0;
_lblthreadstop = 0;
 //BA.debugLineNum = 96;BA.debugLine="userimage.Initialize(File.DirAssets,\"defaultima";
_userimage.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"defaultimage.png");
 //BA.debugLineNum = 97;BA.debugLine="PanelTop=0";
_paneltop = (int) (0);
 //BA.debugLineNum = 98;BA.debugLine="scvpanel=ScrollView1.Panel";
mostCurrent._vvvvvvvvvvvv3 = mostCurrent._scrollview1.getPanel();
 //BA.debugLineNum = 100;BA.debugLine="For i=0 To PARAMETERS.Size-1";
{
final int step39 = 1;
final int limit39 = (int) (_parameters.getSize()-1);
for (_i = (int) (0) ; (step39 > 0 && _i <= limit39) || (step39 < 0 && _i >= limit39); _i = ((int)(0 + _i + step39)) ) {
 //BA.debugLineNum = 101;BA.debugLine="Dim m As Map";
_m = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 102;BA.debugLine="m = PARAMETERS.Get(i)";
_m.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_parameters.Get(_i)));
 //BA.debugLineNum = 104;BA.debugLine="Dim subpanel As Panel";
_subpanel = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 105;BA.debugLine="Dim lblusername As Label";
_lblusername = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 106;BA.debugLine="Dim lblstatus As Label";
_lblstatus = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 107;BA.debugLine="Dim lblemail As  Label";
_lblemail = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 108;BA.debugLine="Dim myimageview As ImageView";
_myimageview = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 109;BA.debugLine="Dim mybtn As Button";
_mybtn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 111;BA.debugLine="subpanel.Initialize(\"subpanel\")";
_subpanel.Initialize(mostCurrent.activityBA,"subpanel");
 //BA.debugLineNum = 113;BA.debugLine="PanelHeight=74dip";
_panelheight = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (74));
 //BA.debugLineNum = 114;BA.debugLine="lblthreadsTop=53dip";
_lblthreadstop = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (53));
 //BA.debugLineNum = 120;BA.debugLine="scvpanel.AddView(subpanel,0,PanelTop,ScrollView";
mostCurrent._vvvvvvvvvvvv3.AddView((android.view.View)(_subpanel.getObject()),(int) (0),_paneltop,mostCurrent._scrollview1.getWidth(),_panelheight);
 //BA.debugLineNum = 121;BA.debugLine="subpanel.Color=Colors.ARGB(0,0,0,0)";
_subpanel.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (0),(int) (0),(int) (0),(int) (0)));
 //BA.debugLineNum = 123;BA.debugLine="Dim myuser As String";
_myuser = "";
 //BA.debugLineNum = 124;BA.debugLine="myuser=m.Get(\"Username\")";
_myuser = BA.ObjectToString(_m.Get((Object)("Username")));
 //BA.debugLineNum = 126;BA.debugLine="lblusername.Initialize(\"\")";
_lblusername.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 127;BA.debugLine="subpanel.AddView(lblusername,80dip,5dip,240dip,";
_subpanel.AddView((android.view.View)(_lblusername.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (80)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (240)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 128;BA.debugLine="lblusername.TextSize=18";
_lblusername.setTextSize((float) (18));
 //BA.debugLineNum = 129;BA.debugLine="lblusername.Tag=\"lblusername\"";
_lblusername.setTag((Object)("lblusername"));
 //BA.debugLineNum = 130;BA.debugLine="lblusername.Text=myuser";
_lblusername.setText((Object)(_myuser));
 //BA.debugLineNum = 131;BA.debugLine="lblusername.Color=Colors.ARGB(0,0,0,0)";
_lblusername.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (0),(int) (0),(int) (0),(int) (0)));
 //BA.debugLineNum = 132;BA.debugLine="lblusername.TextColor=Colors.Black";
...
_lblstatus.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Green);
 //BA.debugLineNum = 164;BA.debugLine="myspecid=m.Get(\"User_id\")";
_vv5 = BA.ObjectToString(_m.Get((Object)("User_id")));
 //BA.debugLineNum = 165;BA.debugLine="mybtn.Initialize(\"mybtn\")";
_mybtn.Initialize(mostCurrent.activityBA,"mybtn");
 //BA.debugLineNum = 166;BA.debugLine="mybtn.Tag=myspecid";
_mybtn.setTag((Object)(_vv5));
 //BA.debugLineNum = 167;BA.debugLine="subpanel.AddView(mybtn,250dip,20dip,70dip,40dip";
_subpanel.AddView((android.view.View)(_mybtn.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (250)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (70)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 168;BA.debugLine="mybtn.Text=\"Chat!\"";
_mybtn.setText((Object)("Chat!"));
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Failed, make sure you have an internet connection.",anywheresoftware.b4a.keywords.Common.True);
			...
			processBA.setLastException(e97); //BA.debugLineNum = 181;BA.debugLine="ToastMessageShow(\"No Users Found\", True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("No Users Found",anywheresoftware.b4a.keywords.Common.True);
 };
...
public static String  _mybtn_click() throws Exception{
anywheresoftware.b4a.objects.ButtonWrapper _b = null;
 //BA.debugLineNum = 191;BA.debugLine="Sub mybtn_Click";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Dim myspecid As String";
_vv5 = "";
 //BA.debugLineNum = 10;BA.debugLine="Private contactsspec=\"CUSER\" As String";
_vvvvvvvvvvvvv1 = BA.__b (new byte[] {70,79,-16,-102,93}, 761662);
